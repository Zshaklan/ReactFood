...
const firebaseConfig = {
  apiKey: "AIzaSyAO5RjvczyEeMt_uHAKfq8cR26ybaKSmi8",
  authDomain: "react-food-backend-b4dfb.firebaseapp.com",
  databaseURL:
    "https://react-food-backend-b4dfb-default-rtdb.asia-southeast1.firebasedatabase.app",
  projectId: "react-food-backend-b4dfb",
  storageBucket: "react-food-backend-b4dfb.firebasestorage.app",
  messagingSenderId: "370744018845",
  appId: "1:370744018845:web:042dd2de04b453510bd174",
};
...
async function uploadMeals() {
  try {
    // Save meals under "meals" node
    await set(ref(db, "meals"), meals);
